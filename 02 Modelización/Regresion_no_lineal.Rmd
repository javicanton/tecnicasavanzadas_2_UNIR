...
subtitle: "Regresiones no lineales"
...
Para verificar los resultados exactos de cada modelo, ejecutamos el siguiente código:

```{r verificacion-resultados}
# 1. Modelo Lineal
cat("\n=== MODELO LINEAL ===\n")
print(summary(modelo_lineal))
cat("\nAIC:", AIC(modelo_lineal))
cat("\nBIC:", BIC(modelo_lineal))

# 2. Modelo Polinomial (grado 2)
cat("\n\n=== MODELO POLINOMIAL (GRADO 2) ===\n")
print(summary(modelo_poly2))
cat("\nAIC:", AIC(modelo_poly2))
cat("\nBIC:", BIC(modelo_poly2))

# 3. Modelo Polinomial (grado 3)
cat("\n\n=== MODELO POLINOMIAL (GRADO 3) ===\n")
print(summary(modelo_poly3))
cat("\nAIC:", AIC(modelo_poly3))
cat("\nBIC:", BIC(modelo_poly3))
...
# 5. Modelo Splines
cat("\n\n=== MODELO SPLINES ===\n")
print(summary(modelo_splines))
cat("\nAIC:", AIC(modelo_splines))
cat("\nBIC:", BIC(modelo_splines))
