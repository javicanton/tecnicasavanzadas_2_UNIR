...
param_size <- 5 # Número de neuronas en la capa oculta 
param_decay <- 0.01 # Tasa de decaimiento de la regularización
param_maxit <- 300 # Número máximo de iteraciones
